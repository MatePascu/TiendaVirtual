...
INSERT INTO `persona` (`idpersona`, `identificacion`, `nombre`, `apellido`, `telefono`, `email_user`, `password`, `nit`, `nombrefiscal`, `direccionfiscal`, `toke`, `rolid`, `datecreated`, `status`) VALUES
