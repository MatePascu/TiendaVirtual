document.write(`<script src="${base_url}/Assets/js/plugins/JsBarcode.all.min.js"></script>`); //Incluye libreria para codigo de barras
let tableProductos;
// let rowTable = "";
...
if(document.querySelector("#txtCodigo")){ // Evento para generar codigo de barra
